import { useGetFilmsTopQuery } from '@entities/movies/api/kinopoiskApi.ts';
import { useEffect, useState } from 'react';
import { useLocation, useNavigate } from 'react-router';
import { TOP_LISTS } from '@shared/constants/constants.ts';
import { MoviesList } from '@entities/movies/ui/MoviesList/MoviesList.tsx';
import { Button, Typography } from '@mui/material';
import { ArrowBack } from '@mui/icons-material';

export function MoviesSectionPage() {
